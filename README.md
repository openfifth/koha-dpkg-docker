...
Make sure you have checked out the branch you would like. To do this (using 25.11 as an example):
```bash
cd /home/koha/kohaclone
git fetch origin ; git checkout -b 25.11.custom --track origin/25.11.x
```
...
docker run \
    ...
    ghcr.io/openfifth/koha-dpkg-docker:25.11
```
